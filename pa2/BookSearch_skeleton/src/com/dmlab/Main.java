...
public class Main {
	...
	private static final int GET_MIN = 3;
	private static final int GET_MAX = 4;
	private static final int SIZE = 5;
	private static final int PRINT_ALL = 6;
	private static final int ORDER_SEARCH = 7;
	...
	public static void main(String[] args) throws Exception {
		...
		for (String line = reader.readLine(); line != null; line = reader.readLine()) {
			...
			case GET:
				...
				break;
			case GET_MIN:
				name = bookSearch.get_min();
				if (name == null)
					System.out.println("BookSearch cannot find the book");
				else
					System.out.println("GET MIN:\t" + name);
				break;
			case GET_MAX:
				name = bookSearch.get_max();
				if (name == null)
					System.out.println("BookSearch cannot find the book");
				else
					System.out.println("GET MAX:\t" + name);
				break;
			case SIZE:
	...
	private static int getCommandNum(String cmd) {
		if (cmd.equals("add"))
			...
			return GET;
		else if (cmd.equals("get_min"))
			return GET_MIN;
		else if (cmd.equals("get_max"))
			return GET_MAX;
